...
fun Route.productRoutes() {
    route("/products") {
        ...
        // Get a product by ID
        get("/{id}") {
            val productId = call.parameters["id"] ?: return@get call.respond(HttpStatusCode.BadRequest, "Missing product ID")
            ...
            // Find the product
            val product = products.find { it.id == productId } ?: return@get call.respond(HttpStatusCode.NotFound, "Product not found")
